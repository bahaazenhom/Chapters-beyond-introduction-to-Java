...
public class ObjectFactory {
    ...
    private final static QName _GetAddress_QNAME = new QName("http://chapter_41/", "getAddress");
    private final static QName _GetAddressResponse_QNAME = new QName("http://chapter_41/", "getAddressResponse");
    private final static QName _InitializeJdbc_QNAME = new QName("http://chapter_41/", "initializeJdbc");
    private final static QName _InitializeJdbcResponse_QNAME = new QName("http://chapter_41/", "initializeJdbcResponse");
    private final static QName _StoreAddress_QNAME = new QName("http://chapter_41/", "storeAddress");
    private final static QName _StoreAddressResponse_QNAME = new QName("http://chapter_41/", "storeAddressResponse");
     ...
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link GetAddress }{@code >}
     */
    @XmlElementDecl(namespace = "http://chapter_41/", name = "getAddress")
     ...
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link GetAddressResponse }{@code >}
     */
    @XmlElementDecl(namespace = "http://chapter_41/", name = "getAddressResponse")
     ...
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link InitializeJdbc }{@code >}
     */
    @XmlElementDecl(namespace = "http://chapter_41/", name = "initializeJdbc")
     ...
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link InitializeJdbcResponse }{@code >}
     */
    @XmlElementDecl(namespace = "http://chapter_41/", name = "initializeJdbcResponse")
     ...
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link StoreAddress }{@code >}
     */
    @XmlElementDecl(namespace = "http://chapter_41/", name = "storeAddress")
     ...
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link StoreAddressResponse }{@code >}
     */
    @XmlElementDecl(namespace = "http://chapter_41/", name = "storeAddressResponse")
