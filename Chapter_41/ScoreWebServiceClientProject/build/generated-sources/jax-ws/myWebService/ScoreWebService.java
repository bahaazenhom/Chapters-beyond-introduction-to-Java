 ...
 * 
 */
@WebServiceClient(name = "ScoreWebService", targetNamespace = "http://chapter_41/", wsdlLocation = "http://localhost:8080/Chapter_41/ScoreWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName SCOREWEBSERVICE_QNAME = new QName("http://chapter_41/", "ScoreWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Chapter_41/ScoreWebService?WSDL");
    ...
    public ScoreService getScoreServicePort() {
        return super.getPort(new QName("http://chapter_41/", "ScoreServicePort"), ScoreService.class);
    }
    ...
    public ScoreService getScoreServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://chapter_41/", "ScoreServicePort"), ScoreService.class, features);
    }
