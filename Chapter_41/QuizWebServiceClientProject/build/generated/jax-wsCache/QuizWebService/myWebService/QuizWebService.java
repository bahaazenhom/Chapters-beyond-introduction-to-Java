 ...
 * 
 */
@WebServiceClient(name = "QuizWebService", targetNamespace = "http://chapter_41/", wsdlLocation = "http://localhost:8080/WebServiceProject/QuizWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName QUIZWEBSERVICE_QNAME = new QName("http://chapter_41/", "QuizWebService");
    ...
    public QuizService getQuizServicePort() {
        return super.getPort(new QName("http://chapter_41/", "QuizServicePort"), QuizService.class);
    }
    ...
    public QuizService getQuizServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://chapter_41/", "QuizServicePort"), QuizService.class, features);
    }
